      ...
      <nav class="navbar col-md" style="background-color: black;">
        ...
        <a class="navbar-brand" style="color:#3cff00; font-size: 25px;padding: 20px;">CHRISTIAN AID ORGANISATION</a>
            ...
            <ul class="navbar-nav  me-auto my-2 my-lg-0" style="--bs-scroll-height: 50px; display :block;">
                ...
                <li class="nav-item">
                <button class="btn btn-success" type="button" id="admin"><a class="nav-link" href="admindash.php">Admin</a></button>
                </li>
                
                
              </ul>         

              <button class="btn btn-outline-danger" type="button" id="donate"><a class="nav-link" href="adminlogin.php">LOGOUT</a></button>
